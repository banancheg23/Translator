...
import com.banancheg.historyscreen.R
...
class HistoryAdapter : RecyclerView.Adapter<HistoryAdapter.RecyclerItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemViewHolder {
        return RecyclerItemViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.activity_history_recycler_view_item, parent, false))
    }
    ...
    class RecyclerItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(data: DataModel) {
            ...
            itemView.findViewById<TextView>(R.id.header_history_textview_recycle_item).text = data.text
